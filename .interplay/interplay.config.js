...
module.exports = () => {
    return {
        ...
        packages: [
            {
                name: 'denali-design/react', //Name of package to import
                packagePath: './package.json', //Path to package.json
                src: '.interplay/index.tsx', //Entry file for component parsing
                build: '.interplay/index.tsx', //Entry file for component bundling
                ignoreExports: [
                    'getBgColorClassName',
                    'getColorClassName',
                    'getFontFamilyClassName',
                    'getFontWeightClassName',
                ], //Exports to ignore when parsing
            },
        ],
        ...
        presetPaths: ['src/*/__stories__/index.stories.jsx'],
        ...
        includePaths: [
            ...
            //add this then set body classname in wrapper
            //'.storybook/css/denali-dark-theme.css',
            'node_modules/denali-css/css/denali-dark-theme.css',
        ],

        // tokenPaths: [
        //     // 'node_modules/denali-css/scss/denali-theme-vars.scss', //contains rgba that needs transforming by sass
        //     'node_modules/denali-css/scss/denali-dynamic-vars.scss',
        // ],
        ...
        //Specify JSON files to parse for design tokens, keyed on theme ID
        //designTokens: {
        //  default: {
        //     paths: [], //glob path for JSON files containing design tokens
        //     format: "<format string>", //format of your tokens JSON
        //     name: "Default Theme", //display name of this theme
        //  },
        //},

        //OVERRIDING CLI BEHAVIOUR
